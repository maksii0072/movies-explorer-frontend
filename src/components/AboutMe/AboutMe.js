    ...
    <section className="about-me" id="about-me">
      ...
      <div className="about-me__container">
        <article className="about-me__content">
          ...
          Я родился в Ростовской области.Живу в Москве. Закончил Ростовский институт по специальности: Автоматизированные сиситемы обработки информации и управления.В свободное вермя от работы,я люблю читать книги играть на гитаре, в остальное время повышаю навыки Веб-разработки.
          </p>
          <a
